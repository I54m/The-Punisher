package me.fiftyfour.punisher.bukkit.objects.punishmenu.leveltwo;
...
public class LevelTwoPunishMenuV1_9 implements LevelTwoPunishMenu {
    ...
    public void setupMenu() {
        ...
        MENU.addButton(15, new ItemStack(Material.valueOf("SKULL_ITEM"), 1, (short) 5), ChatColor.RED + "Scamming", ChatColor.WHITE + "When a player is unfairly taking a player's money", ChatColor.WHITE + "Through a fake scheme");
        ...
        MENU.addButton(25, new ItemStack(Material.CHORUS_FRUIT, 1), ChatColor.RED + "Exploiting", ChatColor.WHITE + "Includes Bypassing Land Claims and Cobble Monstering");
