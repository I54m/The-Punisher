package me.fiftyfour.punisher.bukkit.objects.punishmenu.levelzero;

import org.bukkit.ChatColor;
import org.bukkit.Material;
import org.bukkit.inventory.ItemStack;

public class LeveLZeroPunishMenuV1_13 implements LevelZeroPunishMenu {
    ...
    public void setupMenu() {
        ...
        MENU.addButton(12, new ItemStack(Material.BLUE_ICE, 1), ChatColor.RED + "Minor Chat Offence", ChatColor.WHITE + "Spam, Flood ETC");
        MENU.addButton(13, new ItemStack(Material.MAGMA_BLOCK, 1), ChatColor.RED + "Major Chat Offence", ChatColor.WHITE + "Racism, Disrespect ETC");
