...
public class LevelThreePunishMenuV1_15 implements LevelThreePunishMenu {
    ...
    public void setupMenu() {
        ...
        MENU.addButton(24, new ItemStack(Material.OAK_SIGN, 1), ChatColor.RED + "Server Advertisement", ChatColor.RED + "Warning: Must Also Clear Chat After you have proof!!");
