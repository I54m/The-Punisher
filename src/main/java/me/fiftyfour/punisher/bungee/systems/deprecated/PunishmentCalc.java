package me.fiftyfour.punisher.bungee.systems.deprecated;
...
public class PunishmentCalc implements Listener {
    ...
    /*
        ...
        This is the old pre 1.7+ punishment calculation system, it has been deprecated and is no longer in use.
        The class was left in as part of the project to keep a record of old systems and show how the code has been changed and optimized.
    ...
    private void punish(String uuid, String reason) throws SQLException{
            ...
            if (punishment.equalsIgnoreCase("warn")) {
                ...
                + " \nThis may be due to a misconfiguration in the punishments.yml file, if you can't find the misconfiguration do /punisher punishments reset to reset them to their default values!");
            }
    }
